...
public class UpdateRoom extends JFrame implements ActionListener {
    ...
    Choice ccustomer;
    TextField tfroom,tfstatus, tfavailable,tfpaid, tfpending;
    ...
    UpdateRoom(){
        ...
        JLabel lblname = new JLabel("Availibility");
    ...
    public void actionPerformed(ActionEvent ae){
       ...
       try{
           ...
           while(rs2.next()){
            tfavailable.setText(rs2.getNString("availability"));
