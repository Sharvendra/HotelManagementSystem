...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    JTextField tfname, tfage, tfemail, tfphone, tfsalary, tfadhar;
   ...
   bg.add(rbfemale);
    ...
    String str[] = {"Front Desk Clerks", "Porters", "HouseKeeping", "Kitchen Staff", "Room Service", "Manager"};
 ...
 public void actionPerformed(ActionEvent ae){
   ...
   if(name.equals("")){
    JOptionPane.showMessageDialog(null, "Nmae should not be empty");return;
   }
